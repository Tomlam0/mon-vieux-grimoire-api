...
export const RatingUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.RatingUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default RatingUpdateManyWithoutUserNestedInputSchema;
