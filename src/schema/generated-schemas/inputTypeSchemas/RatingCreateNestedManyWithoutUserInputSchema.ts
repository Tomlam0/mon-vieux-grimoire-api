...
export const RatingCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.RatingCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export default RatingCreateNestedManyWithoutUserInputSchema;
