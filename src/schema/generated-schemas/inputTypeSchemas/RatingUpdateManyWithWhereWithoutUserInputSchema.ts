...
export const RatingUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.RatingUpdateManyWithWhereWithoutUserInput> =
  z
    .object({
      where: z.lazy(() => RatingScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => RatingUpdateManyMutationInputSchema),
        z.lazy(() => RatingUncheckedUpdateManyWithoutUserInputSchema),
      ]),
    })
    .strict();
