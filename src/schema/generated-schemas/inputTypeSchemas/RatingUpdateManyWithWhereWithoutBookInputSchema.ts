...
export const RatingUpdateManyWithWhereWithoutBookInputSchema: z.ZodType<Prisma.RatingUpdateManyWithWhereWithoutBookInput> =
  z
    .object({
      where: z.lazy(() => RatingScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => RatingUpdateManyMutationInputSchema),
        z.lazy(() => RatingUncheckedUpdateManyWithoutBookInputSchema),
      ]),
    })
    .strict();
