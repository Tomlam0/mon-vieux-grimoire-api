...
export const BookUpdateOneRequiredWithoutRatingsNestedInputSchema: z.ZodType<Prisma.BookUpdateOneRequiredWithoutRatingsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => BookUpdateToOneWithWhereWithoutRatingsInputSchema),z.lazy(() => BookUpdateWithoutRatingsInputSchema),z.lazy(() => BookUncheckedUpdateWithoutRatingsInputSchema) ]).optional(),
}).strict();
