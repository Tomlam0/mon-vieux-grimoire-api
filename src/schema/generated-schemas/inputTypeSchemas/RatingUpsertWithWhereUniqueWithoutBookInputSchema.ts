...
export const RatingUpsertWithWhereUniqueWithoutBookInputSchema: z.ZodType<Prisma.RatingUpsertWithWhereUniqueWithoutBookInput> =
  z
    .object({
      where: z.lazy(() => RatingWhereUniqueInputSchema),
      update: z.union([
        z.lazy(() => RatingUpdateWithoutBookInputSchema),
        z.lazy(() => RatingUncheckedUpdateWithoutBookInputSchema),
      ]),
      create: z.union([
